...
export const animalRescatadoSlice = createSlice({
    name: 'animalRescatadoSlice',
    initialState: {  
        nombre:'',
        estado:'',
        peso:'',
...
export const {updateInfoForm, updateEsterilizacionForm, updateDesparacitadoForm} = animalRescatadoSlice.actions;